...
public class ComponentWithDependencies {
  ...
  /*
  Note that the @PostConstruct is not a Spring annotation,
   but a Java EE annotation. It is recognized by Spring though, and Spring calls methods annotated
   with @PostConstruct only once, just after the initialization of bean properties.
   */
  @PostConstruct
